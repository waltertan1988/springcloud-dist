...
insert into `sys_menu` (`id`, `created_by`, `created_date`, `last_modified_by`, `last_modified_date`, `is_group`, `menu_code`, `menu_name`, `parent_code`, `uri`) values(NULL,'*ADMIN','2019-04-29 23:15:36','*ADMIN','2019-04-29 23:15:41','','PUBLIC_INDEX_PAGE','首页','ROOT','/index');
insert into `sys_menu` (`id`, `created_by`, `created_date`, `last_modified_by`, `last_modified_date`, `is_group`, `menu_code`, `menu_name`, `parent_code`, `uri`) values(NULL,'*ADMIN','2019-05-01 01:40:37','*ADMIN','2019-05-01 01:40:42','','ADMIN_SYSADM_ROLE','角色管理','ROOT','/admin/sysAdm/role');

insert into `sys_role_resource` (`id`, `created_by`, `created_date`, `last_modified_by`, `last_modified_date`, `resource_code`, `resource_type`, `role_code`) values(NULL,'*ADMIN','2019-05-01 01:18:13','*ADMIN','2019-05-01 01:18:13','PUBLIC_INDEX_PAGE','MENU','ROLE_USER');
insert into `sys_role_resource` (`id`, `created_by`, `created_date`, `last_modified_by`, `last_modified_date`, `resource_code`, `resource_type`, `role_code`) values(NULL,'*ADMIN','2019-05-01 01:42:36','*ADMIN','2019-05-01 01:42:41','ADMIN_SYSADM_ROLE','MENU','ROLE_ADMIN');
