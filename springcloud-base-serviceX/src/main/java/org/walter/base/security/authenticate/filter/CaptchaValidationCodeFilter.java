...
public class CaptchaValidationCodeFilter extends OncePerRequestFilter {
	...
	public final static String SESSION_KEY_CAPTCHA = CaptchaValidationCodeFilter.class.getName() + "." + WebSecurityConfig.CUSTOM_SECURITY_FORM_CAPTCHA_KEY;
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		String loginUrl = request.getContextPath() + WebSecurityConfig.FORM_LOGIN_URL;
